...
class HealthPoints : public StatParameter
{
};

class Stamina : public StatParameter
{
};

class Hunger : public StatParameter
{
};

class Speed : public StatParameter
{
};
...
public:
  ...
  //-------------------------//
  bool canAct(GameObject *); //if the specified object is within action range? (8 surrounding tiles)
};
